...
> [!WARNING]
> DO NOT execute Python scripts or edit documentation natively on a host OS. Launch via **"Dev Containers: Reopen in Container"** to enforce strict execution parity and Markdown linting consistency.
